...
## The Rule of Cool (Primary Standing Rule)
...
- A player wants to use a spell in an unconventional way — allow it if the fictional logic holds, possibly with a reduced effect or a concentration check
- A player wants to talk to an enemy mid-combat — allow it, run it as a Persuasion check, and be willing to let it work if the roleplay is good

---

## Standing Rulings

_None yet — populated as the campaign progresses._
...
## Notes on 2024 Edition Adoption

We use DnD 5e 2024 as the primary ruleset. Where character sheets were written using 2014 assumptions, the following corrections apply:

- **Grunka's Frenzy**: 2024 Frenzy does NOT cause exhaustion. Grunka's character sheet referenced the 2014 version. Use 2024 rules: Frenzy allows an additional attack as a bonus action while raging, no exhaustion cost.
- **Reginald's Divine Smite**: In 2024, Divine Smite triggers as a **reaction** after a successful hit (not declared before rolling). Reginald may decide to smite after seeing the hit land.
- All other abilities are functionally compatible between editions for this party.
